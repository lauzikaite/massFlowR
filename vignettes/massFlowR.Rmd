...
* Detects communities of peak within the correlation network (`igraph` package algorithm 
...
If in-house chemical reference database is available, PCS are annotated. For more details how to build a database file, see [annotation using database](http://htmlpreview.github.io/?https://github.com/lauzikaite/massFlowR/blob/master/inst/doc/annotation.html))).
